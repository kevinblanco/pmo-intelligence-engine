"""
Resource Advisor Agent — FastAPI A2A server
...
logger = logging.getLogger("resource-advisor")

app = FastAPI(title="Resource Advisor Agent")
...
async def a2a_endpoint(request: Request):
    ...
    logger.info(f"[resource-advisor] Received request id={rpc_id}")
    ...
    logger.info(f"[resource-advisor] Completed request id={rpc_id}")
    return JSONResponse(
        content={
            "jsonrpc": "2.0",
            "id": rpc_id,
